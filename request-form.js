...
document.addEventListener('DOMContentLoaded', function() {
    ...
    button.addEventListener('click', function() {
      if (faviconUrl) {
        ...
        if (faviconDataIndex !== -1) {
          ...
          let faviconData = { inputName: 'favicon', value: faviconUrl };
  ...
  // Intl-tel-input
  let intlInput = form.querySelector('input[data-intl-phone="true"]'),
      dialCode = form.querySelector('input[name="dial_code"]'),
